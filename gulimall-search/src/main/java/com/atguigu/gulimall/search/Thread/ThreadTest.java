...
//        System.out.println("main......end....." + future.get());
        ...
        /**
         * 两任务都要完成
         * runAfterBothAsync 不能感知前两个结果,无返回值
         * thenAcceptBothAsync 感知前两个结果,无返回值
         * thenCombineAsync 感知前两个结果,有返回值
         */
...
//        CompletableFuture<String> f = future01.applyToEitherAsync(future02, res -> {
//            System.out.println("任务三开始"+res);
//            return res.toString() + "->哈哈";
//        }, executor);

        CompletableFuture<String>futureImage = CompletableFuture.supplyAsync(() -> {
            System.out.println("查询图片商品信息");
            return "hello.jpg";
        }, executor);
//        System.out.println("main....end....");
