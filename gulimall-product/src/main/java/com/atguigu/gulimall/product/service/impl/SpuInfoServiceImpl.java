...
//        封装每个sku信息
        ...
        List<SkuEsModel> upProducts = skuInfoEntities.stream().map(sku -> {
            ...
            skuEsModel1.setSkuPrice(sku.getPrice());
            skuEsModel1.setSkuImg(sku.getSkuDefaultImg());

            if (finalStockMap == null) {
                skuEsModel1.setHasStock(true);
            } else {
                skuEsModel1.setHasStock(finalStockMap.get(sku.getSkuId()));
            }
            //TODO 2、热度评分。0
            //TODO 3、查询品牌和分类的名字信息
            ...
            CategoryEntity byId1 = categoryService.getById(skuEsModel1.getCatalogId());
